...
;# Written by: Amos Zaslavsky (C)copyright - Ver 7.0 #
;#####################################################
puts \n
if {![is_project_open]} {
   puts "========================================"
...
#   set_location_assignment PIN_B12 -to CLOCK_50_2 ;# Global Clock 9
   ...
   set_location_assignment PIN_G3 -to btn_up ;# KEY1/BUTTON1 (mid button - half covered)
   set_location_assignment PIN_F1 -to btn_down ;# KEY2/BUTTON2 (left button)
   ...
   set_location_assignment PIN_J6 -to wave_sel[1] ;# SW[0]
   set_location_assignment PIN_H5 -to wave_sel[0] ;# SW[1]
   set_location_assignment PIN_H6 -to vib_ena ;# SW[2]
   set_location_assignment PIN_G4 -to trem_ena ;# SW[3]
   set_location_assignment PIN_G5 -to arp_ena ;# SW[4]
   set_location_assignment PIN_J7 -to lpf_ena ;# SW[5]
   set_location_assignment PIN_H7 -to detune_ena ;# SW[6]
   set_location_assignment PIN_E3 -to pluck_ena ;# SW[7]
   set_location_assignment PIN_E4 -to delay_ena  ;# SW[8]
   set_location_assignment PIN_D2 -to tempo_sync ;# SW[9]
   ...
   set_location_assignment PIN_J1 -to led_vib ;# LEDG[0]
   set_location_assignment PIN_J2 -to led_trem ;# LEDG[1]
   set_location_assignment PIN_J3 -to led_arp ;# LEDG[2]
   set_location_assignment PIN_H1 -to led_lpf ;# LEDG[3]
   set_location_assignment PIN_F2 -to led_detune ;# LEDG[4]
   set_location_assignment PIN_E1 -to led_pluck ;# LEDG[5]
   set_location_assignment PIN_C1 -to led_delay ;# LEDG[6]
#   set_location_assignment PIN_C2 -to led_sync ;# LEDG[7]
   set_location_assignment PIN_B2 -to led_sync ;# LEDG[8]
   set_location_assignment PIN_B1 -to led_tempo ;# LEDG[9] 
...
#   set_location_assignment PIN_D13 -to HEX0_DP  ;# DP 
   ...
   set_location_assignment PIN_F13 -to ones[6] ;# g  HEX0S[0]
   set_location_assignment PIN_F12 -to ones[5] ;# f  HEX0S[1]
   set_location_assignment PIN_G12 -to ones[4] ;# e  HEX0S[2]
   set_location_assignment PIN_H13 -to ones[3] ;# d  HEX0S[3]
   set_location_assignment PIN_H12 -to ones[2] ;# c  HEX0S[4]
   set_location_assignment PIN_F11 -to ones[1] ;# b  HEX0S[5]
   set_location_assignment PIN_E11 -to ones[0] ;# a  HEX0S[6]

#   set_location_assignment PIN_B15 -to HEX1_DP  ;# DP 

   set_location_assignment PIN_A15 -to tens[6] ;# g  HEX1S[0]
   set_location_assignment PIN_E14 -to tens[5] ;# f  HEX1S[1]
   set_location_assignment PIN_B14 -to tens[4] ;# e  HEX1S[2]
   set_location_assignment PIN_A14 -to tens[3] ;# d  HEX1S[3]
   set_location_assignment PIN_C13 -to tens[2] ;# c  HEX1S[4]
   set_location_assignment PIN_B13 -to tens[1] ;# b  HEX1S[5] 
   set_location_assignment PIN_A13 -to tens[0] ;# a  HEX1S[6]

#   set_location_assignment PIN_A18 -to HEX2_DP  ;# DP 

   set_location_assignment PIN_F14 -to hundreds[6] ;# g  HEX2S[0]
   set_location_assignment PIN_B17 -to hundreds[5] ;# f  HEX2S[1]
   set_location_assignment PIN_A17 -to hundreds[4] ;# e  HEX2S[2]
   set_location_assignment PIN_E15 -to hundreds[3] ;# d  HEX2S[3]
   set_location_assignment PIN_B16 -to hundreds[2] ;# c  HEX2S[4]
   set_location_assignment PIN_A16 -to hundreds[1] ;# b  HEX2S[5]
   set_location_assignment PIN_D15 -to hundreds[0] ;# a  HEX2S[6]

#   set_location_assignment PIN_G16 -to HEX3_DP  ;# DP 

   set_location_assignment PIN_G15 -to thousands[6] ;# g  HEX3S[0]
   set_location_assignment PIN_D19 -to thousands[5] ;# f  HEX3S[1]
   set_location_assignment PIN_C19 -to thousands[4] ;# e  HEX3S[2]
   set_location_assignment PIN_B19 -to thousands[3] ;# d  HEX3S[3]
   set_location_assignment PIN_A19 -to thousands[2] ;# c  HEX3S[4]
   set_location_assignment PIN_F15 -to thousands[1] ;# b  HEX3S[5]
   set_location_assignment PIN_B18 -to thousands[0] ;# a  HEX3S[6]
...
#   set_location_assignment PIN_AA12 -to GPIO0_CLKIN[1]  ;# pin  3
   set_location_assignment PIN_AB16 -to fm_out        ;# pin  2
...
#   set_location_assignment PIN_AB11 -to GPIO1_CLKIN[0]  ;# pin  1
   ...
   ;#############################################################
   ;# AddOn card placed on JP1 - the right (external) connector #
   ;#############################################################

#   set_location_assignment PIN_V7   -to TX2_BT    ;# pin 40 Bluetooth on board
#   set_location_assignment PIN_U8   -to RX2_BT    ;# pin 38 Bluetooth on board
#   set_location_assignment PIN_T9   -to TX3_MP3   ;# pin 36 MP3 player on board
#   set_location_assignment PIN_T10  -to RX3_MP3   ;# pin 34 MP3 player on board
#   set_location_assignment PIN_R12  -to TX1       ;# pin 32 PC (FTDI) on board
#   set_location_assignment PIN_T12  -to RX1       ;# pin 28 PC (FTDI) on board
#   set_location_assignment PIN_R14  -to B_LED     ;# pin 26 RGB LED on board
#   set_location_assignment PIN_AB7  -to G_LED     ;# pin 24 RGB LED on board
#   set_location_assignment PIN_AA9  -to R_LED     ;# pin 22 RGB LED on board
#   set_location_assignment PIN_W17  -to SPEAKER   ;# pin 14 mini SPEARKER on board
#   set_location_assignment PIN_AB19 -to SP_R      ;# pin  6 Right AUX audio on board
#   set_location_assignment PIN_AB20 -to SP_L      ;# pin  4 Left  AUX audio on board
